...
const buttonVariants = cva(
  "group/button inline-flex shrink-0 items-center justify-center font-mono text-[11px] font-semibold uppercase tracking-[0.08em] leading-[11px] rounded-[4px] whitespace-nowrap text-center transition-all duration-150 ease-in-out outline-none select-none active:translate-y-px focus-visible:shadow-[0_0_0_1px_var(--ring)] disabled:pointer-events-none disabled:opacity-60 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        ...
        link: "text-primary underline-offset-4 hover:underline normal-case tracking-normal text-[13px] font-medium gap-1",
      },
      size: {
...
function Button({
  ...
  return (
    ...
    >
      {children}
      {variant === "link" && <ExternalLinkIcon className="size-3" />}
    </ButtonPrimitive>
  )
}
